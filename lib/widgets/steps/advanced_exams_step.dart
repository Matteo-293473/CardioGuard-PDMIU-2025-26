    ...
    return Column(
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          onChanged: (newValue) => onRestecgChanged(newValue!),
        ),
        ...
        DropdownButtonFormField<String>(
          ...
          onChanged: (newValue) => onExangChanged(newValue!),
        ),
        const SizedBox(height: 30),
        DropdownButtonFormField<int>(
          ...
          onChanged: (newValue) => onCaChanged(newValue!),
        ),
        const SizedBox(height: 30),
        DropdownButtonFormField<String>(
          initialValue: thal,
          ...
          onChanged: (newValue) => onThalChanged(newValue!),
        ),
      ],
    );
  }
